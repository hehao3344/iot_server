...
int rsa_api_gen_keys(char *pub_key, int len1, char *priv_key, int len2)
{
    ...
    snprintf(pub_key,  len1, "%032lld%032lld", pub.modulus,  pub.exponent);    
    snprintf(priv_key, len2, "%032lld%032lld", priv.modulus, priv.exponent);
...
{   
    ...
    sscanf(mod_buf, "%lld", &pub.modulus);
    sscanf(exp_buf, "%lld", &pub.exponent);
...
{   
    ...
    sscanf(mod_buf, "%lld", &pri.modulus);
    sscanf(exp_buf, "%lld", &pri.exponent);
