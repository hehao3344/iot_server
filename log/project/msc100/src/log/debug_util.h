...
/****************************************************************************/
int debug_print(int way, const char* fmt, ...) __attribute__((format(printf, 2, 3)));
...
#define IOT_DEBUG(fmt, args...)\
        debug_print(IOT_DEBUG_LEVEL_DEBUG, "%d [%s %s:%d DEBUG] "fmt, IOT_DEBUG_LEVEL_DEBUG, g_module_name, __func__, __LINE__, ##args)
#define IOT_INFO(fmt, args...)\
        debug_print(IOT_DEBUG_LEVEL_INFO, "%d [%s %s:%d INFO] "fmt, IOT_DEBUG_LEVEL_INFO, g_module_name, __func__, __LINE__, ##args)
#define IOT_ERROR(fmt, args...)\
        debug_print(IOT_DEBUG_LEVEL_ERROR, "%d [%s %s:%d ERROR]  "fmt, IOT_DEBUG_LEVEL_ERROR, g_module_name, __func__, __LINE__, ##args)
