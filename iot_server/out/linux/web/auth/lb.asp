        ...
        <tr>
          <td colspan="0">
            <div id=cameraSetTb style="display: none; margin-top:0px; margin-bottom:0px; margin-left:45px" align="left">
			  <span style="font-size: 12px"><img src="/images/drop_down_menu.gif"><a href="/basic/disp.asp" target="mainFrame">显示/删除</a></span><br>
			  <span style="font-size: 12px"><img src="/images/drop_down_menu.gif"><a href="/basic/add.asp" target="mainFrame">添加设备</a></span><br>
			</td>
        </tr>
        <tr>
          <td colspan="0"></td>
